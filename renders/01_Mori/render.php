...
// add otherGlasses
    addShearedGlass($im,$im_glass,'rgba(20,20,20,0.4)',330 ,50,360,130,15);
    addShearedGlass($im,$im_glass,'rgba(20,20,20,0.4)',330 - 70*tan(deg2rad(15)) ,200,360,50,15);// 70 = y2 + h2 - y1 -h1
    addShearedGlass($im,$im_glass,'rgba(20,20,20,0.4)',330 - 170*tan(deg2rad(15)) ,270,360,80,15);// 270 + 80 - 50 - 130
// Text
    $text = new Imagick();
...
// Level && Online  Games  Played  &&  Coop  Games  Played
    ...
    $draw -> setFontSize(45);
    $draw -> annotation(385, 137, $contentObject[3]["STAT_PLAYER_LEVEL"]["value"]);
    $draw -> annotation(508, 92, $contentObject[3]["STAT_ONLINE_GAMES_PLAYED"]["value"]);
    $draw -> annotation(500, 157, $contentObject[3]["STAT_ONLINE_GAMES_WON"]["value"]);


// Line2
    $draw -> setFontSize(30);
    $draw -> annotation(370, 234, $contentObject[3]["STAT_C_GAMES_PLAYED"]["value"]);
    $draw -> annotation(520, 234, $contentObject[3]["STAT_ONLINE_BH_GAMES_PLAYED"]["value"]);
// Coop role levels
    $draw -> setFontSize(37);
    $role_distance = 60;
    $role_x = 300;
...
// Titles
    ...
    $draw -> setFontSize(17);
    $draw -> annotation(385, 96, 'Level');
    $draw -> annotation(555, 110, 'Online  Games  Played');
    $draw -> annotation(537, 175, 'Online  Games  Won');
    $draw -> annotation(430, $role_y - 40, 'Coop Role Levels');
    $draw -> annotation(415, 248, 'Coop Games Played');
    $draw -> annotation(565, 248, 'BH Games Played');
